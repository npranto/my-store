      ...
      <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        <div class="w-full">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pb-8 max-xl:mx-auto">
            <div class="box flex flex-col gap-y-4 w-full ">
              <div class="flex items-center w-full">
                <p class="font-medium text-base text-black mr-0.5 w-3">1</p>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 20 20"
                ...
                <p class="h-2 w-full flex-grow rounded-3xl bg-amber-50 ml-5 mr-3">
                  <span class="h-full w-[30%] rounded-3xl bg-amber-400 flex"></span>
                </p>
                <p class="font-medium text-base text-black mr-0.5 w-14 text-right">
                  989
                </p>
              </div>
              <div class="flex items-center w-full">
                <p class="font-medium text-base text-black mr-0.5 w-3">2</p>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 20 20"
              ...
              <div class="flex items-center w-full">
                <p class="font-medium text-base text-black mr-0.5 w-3">3</p>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 20 20"
              ...
              <div class="flex items-center w-full">
                <p class="font-medium text-base text-black mr-0.5 w-3">4</p>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 20 20"
              ...
              <div class="flex items-center w-full">
                <p class="font-medium text-base text-black mr-0.5 w-3">5</p>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 20 20"
            ...
            <div class="p-4 bg-amber-50 rounded-3xl flex items-center justify-center flex-col">
              <h2 class="font-manrope font-bold text-4xl text-amber-400 mb-4">
                4.3
              </h2>
              ...
              <p class="font-medium text-base leading-8 text-gray-900 text-center">
                46 Ratings
              </p>
            </div>
          </div>
          ...
          <div class="py-8 max-w-2xl">
            ...
            <h3 class="font-manrope font-semibold text-md sm:text-lg leading-9 text-black mb-6">
            ...
            <p class="font-normal text-base leading-6 text-gray-400 max-xl:text-justify">
