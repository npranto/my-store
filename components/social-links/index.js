...
export default function SocialLinks({ socials = SOCIALS }) {
  return (
    <div class="py-2 sm:py-4 sm:px-5 flex flex-wrap items-center">
        ...
        {socials.map((social) => {
          ...
          return (
            <a
              key={social.name}
              href={social.href}
              class="text-gray-500 bg-slate-100 rounded-full p-2 cursor-pointer"
            >
              <SVGComponent />
            </a>
          );
