  ...
  return (
    <div className="w-full" data-component-id="shopping-cart">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="cart-items flex flex-col gap-4 lg:max-w-[55vw] overflow-auto">
          <div className="rounded-lg border-2 border-gray-100 p-4 gap-y-2 flex flex-col sm:flex-row gap-4">
            <div className="w-[180px] h-[180px] rounded-lg mb-4 flex flex-col">
              <Image
        ...
        <div className="subtotal-info flex-1">
          <div className="flex flex-row items-center justify-between pb-6 border-b border-gray-200">
            <h5 className="text-gray-500 font-manrope font-semibold text-xl leading-9 w-full max-md:mb-4">
              Subtotal
            </h5>
